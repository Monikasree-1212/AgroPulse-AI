...
const schemeData = [
  {
    ...
    description: "Provides income support of Rs.6,000 per year to all landholding farmer families across India in three equal instalments of Rs.2,000 every four months.",
    ...
    benefits: "Rs.6,000 per year direct bank transfer in 3 instalments of Rs.2,000 each.",
  ...
  },
  {
    ...
    benefits: "Revolving credit up to Rs.3 lakh at 4% interest rate per annum with interest subvention. Flexible repayment based on harvest and marketing period.",
  ...
  },
  {
    ...
    benefits: "Rs.50,000 per hectare over 3 years for organic inputs, certification, and marketing. Includes Rs.31,000 for organic inputs and Rs.8,800 for value addition.",
  ...
  },
  {
    ...
    benefits: "Loans up to Rs.2 crore with 3% interest subvention per annum for 7 years. Credit guarantee coverage under CGTMSE for loans up to Rs.2 crore.",
