const fs = require('fs');
const filePath = './backend/data/sampleData.js';
let content = fs.readFileSync(filePath, 'utf8');

const newSchemes = `const governmentSchemes = [
  {
    "title": "PM-KISAN",
...
// Replace from "const governmentSchemes = [" to "module.exports = {"
const replaced = content.replace(/const governmentSchemes = \[\s*\{[\s\S]*?module\.exports = \{/, newSchemes);

fs.writeFileSync(filePath, replaced);
console.log('Schemes successfully reduced and curated.');
