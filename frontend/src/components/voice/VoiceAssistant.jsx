...
export default function VoiceAssistant() {
  ...
  const sendQuery = useCallback(async (text) => {
    ...
    setProcessing(true)
    try {
      const { data } = await axios.post('/api/voice/query', { text })
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4 min-h-0">
              ...
              {listening && transcript && (
                <div className="flex gap-3 animate-fadeIn flex-row-reverse">
                  <div className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-base flex-shrink-0">🧑‍🌾</div>
              ...
              {processing && (
                <div className="flex gap-3 animate-fadeIn">
                  <div className="w-8 h-8 rounded-full bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 flex items-center justify-center text-base flex-shrink-0">🤖</div>
