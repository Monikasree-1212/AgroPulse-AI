    ...
    >
      ...
      <div className="grid grid-cols-2 gap-2">
        {[
          ...
          { label: 'Expected Profit', value: `Rs.${mandi.expectedProfit}/kg`,          color: isBest ? 'text-yellow-600 dark:text-yellow-400 font-extrabold' : 'text-violet-600 dark:text-violet-400' },
