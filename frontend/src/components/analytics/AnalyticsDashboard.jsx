...
export default function AnalyticsDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* KPI Cards */}
      {loading && (
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-[18px]">
      ...
      {!loading && !error && data && (
        <>
          {/* KPI Grid */}
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-[18px] items-stretch">
            {kpis.map(k => (
